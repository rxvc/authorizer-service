 ...
 * 2015-02-16T20:42:36.741-05:00
 * Generated source version: 2.7.0
 * 
 */
@WebServiceClient(name = "RecepcionComprobantesService", 
                  wsdlLocation = "https://cel.sri.gob.ec/comprobantes-electronicos-ws/RecepcionComprobantes?wsdl",
...
public class RecepcionComprobantesService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("https://cel.sri.gob.ec/comprobantes-electronicos-ws/RecepcionComprobantes?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RecepcionComprobantesService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "https://cel.sri.gob.ec/comprobantes-electronicos-ws/RecepcionComprobantes?wsdl");
        }
        WSDL_LOCATION = url;
    }
