        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AutorizacionComprobantesService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "https://celcer.sri.gob.ec/comprobantes-electronicos-ws/AutorizacionComprobantes?wsdl");
        }
        WSDL_LOCATION = url;
    }
